    ...
    <div class="apps">
        <ul class="apps-ul">
                ...
                <div class="todo-main">
                    <div class="theme-title">
                        <div class="media">
                            ...
                            <div class="media-body media-body text-right"><a
                    ...
                    <div class="todo-tab theme-tab custom-scroll">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link button-effect active show" data-toggle="pill"
                                    href="#todo1">All</a></li>
                            <li class="nav-item"><a class="nav-link button-effect" data-toggle="pill" href="#todo2">My
                                    to-dos</a>
                            </li>
                            <li><a class="icon-btn btn-light button-effect btn-sm" data-toggle="modal"
                                    data-target="#todoModal"><i data-feather="plus"> </i></a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane active show" id="todo1">
                                <div class="tab-card text-left">
                                    <div class="todo-task">
                                        ...
                                        <div class="todo-list">
                                            <div class="element" id="div_3"><span class="add add-to-do">Add-To-Do</span>
                                            </div>
                                        </div>
                                        <div class="todo-main-content">
                                            <div class="input-text">
                                        ...
                                        <div class="todo-list">
                                            <div class="element" id="div_2"><span class="add add-to-do">Add-To-Do</span>
                                            </div>
                                        </div>
                                        <div class="todo-main-content">
                                            <div class="input-text">
                                        ...
                                        <div class="todo-list">
                                            <div class="element" id="div_1"><span class="add add-to-do">Add-To-Do</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="todo2">
                                <div class="converstaion-docs tab-card"><i class="fa fa-sticky-note-o"></i>
                                    <h5 class="mb-3">No Open To-Dos Here </h5><a class="btn btn-primary btn-sm"
                                        data-toggle="modal" data-target="#createtodoModal">Create A To-Do</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <li id="files">
                ...
                <div class="theme-tab">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link button-effect active" data-toggle="pill"
                                href="#tab1">Media</a>
                        </li>
                        <li class="nav-item"><a class="nav-link button-effect" data-toggle="pill" href="#tab2">Link</a>
                        </li>
                        <li class="nav-item"><a class="nav-link button-effect" data-toggle="pill" href="#tab3">Docs</a>
                        </li>
                    </ul>
                </div>
                <div class="file-tab">
                    <div class="tab-content custom-scroll">
                                                    ...
                                                    <div class="overlay">
                                                        <div class="border-portfolio"><a
                                                                ...
                                                                <div class="overlay-background"><i class="ti-plus"
                                                                    ...
                                                                    src="/theme/assets/images/gallery/1.jpg"
                                                                    alt="portfolio-image" />
                                                            </a></div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="overlay">
                                                        <div class="border-portfolio"><a
                                                                ...
                                                                <div class="overlay-background"><i class="ti-plus"
                                                                    ...
                                                                    src="/theme/assets/images/gallery/2.jpg"
                                                                    alt="portfolio-image" />
                                                            </a></div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="overlay">
                                                        <div class="border-portfolio"><a
                                                                ...
                                                                <div class="overlay-background"><i class="ti-plus"
                                                                    ...
                                                                    src="/theme/assets/images/gallery/3.jpg"
                                                                    alt="portfolio-image" />
                                                            </a></div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="overlay">
                                                        <div class="border-portfolio"><a
                                                                ...
                                                                <div class="overlay-background"><i class="ti-plus"
                                                                    ...
                                                                    src="/theme/assets/images/gallery/4.jpg"
                                                                    alt="portfolio-image" />
                                                            </a></div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="overlay">
                                                        <div class="border-portfolio"><a
                                                                ...
                                                                <div class="overlay-background"><i class="ti-plus"
                                                                    ...
                                                                    src="/theme/assets/images/gallery/5.jpg"
                                                                    alt="portfolio-image" />
                                                            </a></div>
                                                    </div>
                                                </div>
                        ...
                        <div class="tab-pane fade" id="tab2">
                            <div class="link-group">
                                ...
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/12.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                ...
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/3.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                ...
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/8.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                <div class="media"><i data-feather="link"></i>
                                    ...
                                    href="https://themeforest.net/item/bigdeal-ecommerce-html-template/24809149">https://themeforest.net/item/bigdeal-ecommerce-template</a>
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/9.png"
                                        alt="media-img" />
                                    <div class="media-body">
                                        <h5>HTML Template.</h5>
                            ...
                            <div class="link-group">
                                ...
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/11.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                <div class="media">
                                    ...
                                    href="https://themeforest.net/item/multikart-responsive-ecommerce-html-template/22809967">https://themeforest.net/item/multikart-responsive-ecommerce</a>
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/10.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                <div class="media">
                                    ...
                                    href="https://themeforest.net/item/bigboost-ecommerce-html-template/24168053">https://themeforest.net/item/bigboost-ecommerce-html-template</a>
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/7.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                ...
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/4.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                <div class="media"><i data-feather="link"></i>
                                    ...
                                    href="https://themeforest.net/item/reno-multipurpose-html-template/24141678">https://themeforest.net/item/reno-multipurpose-html-template</a>
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/6.png"
                                        alt="media-img" />
                                    <div class="media-body">
                            ...
                            <div class="link-group">
                                ...
                                <div class="media"><img class="img-fluid" src="/theme/assets/images/file_icons/5.png"
                                        alt="media-img" />
                                    <div class="media-body">
                                    ...
                                    <div class="chat-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body"><a
                                                    ...
                                                    href="assets/doc/messenger.html" target="_blank"><i
                                ...
                                <li>
                                    <div class="chat-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body"><a
                                                    class="icon-btn btn-outline-light btn-sm pull-right"
                                                    href="assets/doc/chapter1.MP4" target="_blank"><i
                                                        data-feather="download"></i></a></div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="chat-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body"><a
                                                    class="icon-btn btn-outline-light btn-sm pull-right"
                                                    href="assets/doc/salary.xlsx" target="_blank"><i
                                                        data-feather="download"></i></a></div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="chat-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body"><a
                                                    class="icon-btn btn-outline-light btn-sm pull-right"
                                                    href="assets/doc/document.pdf" target="_blank"><i
                                                        data-feather="download"></i></a></div>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="chat-box">
                                        <div class="media">
                                            ...
                                            <div class="media-body"><a
                                                    class="icon-btn btn-outline-light btn-sm pull-right"
                                                    href="assets/doc/details.txt" target="_blank"><i
                                                        data-feather="download"></i></a></div>
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="notes-main">
                    ...
                    <form class="default-form">
                        <div class="form-group notes-content">
                            ...
                            <ul>
                                <li><a class="icon-btn btn-light button-effect btn-sm" data-toggle="modal"
                                        data-target="#notesModal"><i data-feather="plus"></i></a></li>
                            </ul>
                        </div>
                    </form>
                    <div class="notes-list">
                        <h6 class="mb-2 text-muted">Joshephin Water.10 Jan</h6>
                        <div class="media"><img class="img-fluid mr-3" src="/theme/assets/images/file_icons/5.png"
                                alt="media-img" />
                            <div class="media-body">
                ...
                <div class="reminder-main">
                    ...
                    <div class="reminder-content tab-card"><i class="ti-alarm-clock"></i>
                        <p>Never forget important tasks. Set personal and group reminders.</p><a
                            class="setreminder btn btn-primary button-effect btn-sm" data-toggle="modal"
                            data-target="#setReminder">set reminder</a>
                    </div>
