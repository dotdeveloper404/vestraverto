...
<body>
    <span class="preheader">{{ env('APP_NAME')}} Team has invited you to use
        {{ env('APP_NAME')}} to collaborate with them.</span>
        ...
        <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <p>{{ env('APP_NAME')}} Team has
                                                invited you to use {{ env('APP_NAME')}} Chat to collaborate with them.
                                                Use
                                                the
                                                button below to set up your account and get started:</p>
                                            <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{$link}}" class="f-fallback button"
                                            ...
                                            {{-- <p><strong>P.S.</strong> Need help getting started? Check out our <a
                                                    href="{{help_url}}">help documentation</a>.</p> --}}
                                            <!-- Sub copy -->
